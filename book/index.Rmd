...
- **If you find a typo, error, or anything you think can be improved, click the "edit" icon and you will be redirected to the source markdown file of this page. Then you can easily edit and submit a PR.**
- use left and right arrow keys to navigate to the previous/next page
- click the "font" icon on the top-left and change to a serif font if you happen to hate sans-serif fonts as I do.
...
I'm assuming you're an intermediate-level Rustacean. You should understand the majority of the concepts in [The Book](https://doc.rust-lang.org/book/) and also the basics of raw pointers.
